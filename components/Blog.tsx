        ...
        <div className="container">
            ...
            <div className="grid gap-6 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 mt-14">
                <div className="box shadow-xl rounded-md p-1">
                    <div className="img_text relative">
                        <div className="w-full h-[300px] overflow-hidden rounded-t-lg ">
                            <img src="https://themedox.com/gerow/wp-content/uploads/2023/08/blog01.jpg" className='w-full h-full rounded-t-lg main_img' alt="" />
                        </div>
                        ...
                        <div className='grid grid-cols-2 mt-4'>
                            <div className="flex cursor-pointer">
                                <div className="w-[50px] h-[50px] mr-3">
                                    <img src="https://themedox.com/gerow/wp-content/uploads/2023/08/comment01.png" className='w-full h-full' alt="" />
                                </div>
                ...
                <div className="box shadow-xl rounded-md p-1">
                    <div className="img_text relative">
                        <div className="w-full h-[300px] overflow-hidden rounded-t-lg">
                            <img src="https://themedox.com/gerow/wp-content/uploads/2023/08/blog04.jpg" className='w-full h-full rounded-t-lg main_img' alt="" />
                        </div>
                        <p className='inline-block bg-[#0055FF] px-2 py-2 text-sm text-[#fff] absolute bottom-0 left-0'>Development</p>
                    </div>
                    <div className="content ">
                ...
                <div className="box shadow-xl rounded-md p-1">
                    <div className="img_text relative">
                        <div className="w-full h-[300px] overflow-hidden rounded-t-lg">
                            <img src="https://themedox.com/gerow/wp-content/uploads/2023/08/blog06.jpg" className='w-full h-full rounded-t-lg main_img' alt="" />
                        </div>
                        <p className='inline-block bg-[#0055FF] px-2 py-2 text-sm text-[#fff] absolute bottom-0 left-0'>Development</p>
                    </div>
