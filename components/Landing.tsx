...
const Landing = () => {
  return (
    <div className='md:px-20 px-5 pt-5 shadow pb-1'>
        <div className='flex md:flex-row flex-col justify-around items-center h-full px-5'>
            <div className='flex items-center flex-col justify-center py-10'>
                ...
                <h1 className='font-bold text-black md:text-5xl text-3xl text-center w-[450px] py-3'>Get a Smart Way  For Your Busines</h1>
              ...
              <div className='flex items-center justify-evenly md:justify-between md:w-[400px] w-[90%] py-2'>
...
<svg className="w-8 h-8  bg-blue-800 rounded-full p-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
